...
import "../../style.css";
import { OnePoint } from "../../../services/service";
...
const ItemsOnePoint = () => {
  ...
  const submited = () => {
    ...
    result = OnePoint(output, parseFloat(x0));
    // console.log(result)
    setPosts(result);
    setLoading(false);
        ...
        <ItemFrom>
          <ContainerInput>
            ...
            <table>
              ...
              <th>Root X</th>
              <th>Error</th> */}
              <Table colomn={currentPosts} loading={loading} Attribute={'OnePoint'} indexOfFirstPost={indexOfFirstPost} postsPerPage={postsPerPage}/>
            </table>
